...
<html>
     ...
     <div class="page-container">
       <div class="container">
        ...
        <h1 class="post-title">UpdatePost</h1>
        <hr>
        </article>
        <form name="form1" class="row" action="#" method="post">
        <div class="span2">
        <label for="name">主题<span>*</span> </label>
        </div>
        <div class="span6">
        <input type="text" name="name" id="name" class="required input-xlarge" value="" title="* 请输入主题">
        </div>
        ...
        <div class="span6">
        <input type="text" name="title" id="reason" class="input-xlarge" value="" title="* 请输入标题">
        </div>
        ...
        <div class="span6">
        <textarea name="bbscontent" id="message" class="required span6" rows="6" title="* Please enter your message"></textarea>
        </div>
