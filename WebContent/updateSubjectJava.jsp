...
<html>
     ...
     <div class="page-container">
       <div class="container">
        ...
        <h1 class="post-title">updateSubjectJava</h1>
        <hr>
        </article>
        ...
        <div class="span6">
        <input type="text" name="boardnameJava" class="required input-xlarge" value="" title="* 请输入主题">
        </div>
        ...
        <input type="submit" name="submit" value="update" class="btn btn-inverse">
         ...
         <script type="text/javascript">
					alert("If you want to update board  'Java入门学习'  ");
				</script>
