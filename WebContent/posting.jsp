...
<html>
     ...
     <div class="page-container">
       <div class="container">
        ...
        <form name="form1" class="row" action="postDeal" method="post">
        <div class="span2">
        <label for="name">主题<span>*</span> </label>
        </div>
        <div class="span6">
        <span style="font-size:18px;">
        <select id="projectPorperty" name="subjectArray">  
        <option value="JAVA入门学习">JAVA入门学习</option>  
        <option value="struts入门学习">struts入门学习</option> 
        <option value="Spring入门学习">Spring入门学习</option> 
        <option value=".NET入门学习">.NET入门学习</option>  
        </select>
        <script>  
    form.projectPorperty.value = '${user.projectPorperty}';  
        ...
        <div class="span2">
        <label for="reason">标题 <span>*</span> </label>
        </div>
        <div class="span6">
        <input type="text" name="bbstitle"class="input-xlarge" value="" title="* 请输入标题">
        </div>
        ...
        <div class="span6">
        <textarea name="bbscontent" class="required span6" rows="6" title="* Please enter your message"></textarea>
        </div>
